...
package ai.privado.languageEngine.javascript.review.passes.methodfullname

import ai.privado.languageEngine.javascript.review
import ai.privado.model.ConfigAndRules
import io.shiftleft.semanticcpg.language._

class JavascriptMethodFullNamePassRequireStyleTest extends review.JavascriptTaggingTestBase {
...
class JavascriptMethodFullNamePassImportStyleTest extends review.JavascriptTaggingTestBase {
