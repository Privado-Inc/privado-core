  ...
  "ConfigFilePass2" should {
    ...
    val cpg = code(
      """
        ...
        |
        |odbc_connection = pyodbc.connect("postgresql://myuser:mypassword@10.0.0.1:5432/mydatabase")
        |""".stripMargin,
      "config.py"
    )
